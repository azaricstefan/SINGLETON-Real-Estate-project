...
DROP DATABASE IF EXISTS `real_estate_db_test`;

CREATE DATABASE `real_estate_db_test` DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;

USE `real_estate_db_test`;
...
/*Tri tipa korisnika*/
INSERT INTO `real_estate_db_test`.`user`
(`username`,
`password`,
`fullname`,
`email`,
