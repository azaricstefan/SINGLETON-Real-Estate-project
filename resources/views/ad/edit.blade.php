...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            ...
            <table width="100%">
                ...
                @foreach(\RealEstate\Addition::all() as $addition)
                    <tr>
                        <td width="60%">{{Form::label($addition->description, $addition->description)}}</td>
                        @foreach($ad->hasAdditions as $oneAddition)
                            ...
                            ?>
                        @endforeach
                        <td width="40%" style="text-align: right;">{{Form::checkbox('addition_id[]', $addition->addition_id, $check , [ 'id' => $addition->description, 'style' => 'text-align: right;'])}}</td>
                    </tr>
                @endforeach
            </table>
        ...
        <div class="col-sm-3">
            {{--Mesto za reklamu sa desne strane strane--}}
        </div>
    </div>
        <div class="row">
            <div class="col-sm-3">
                {{--Mesto za reklamu sa leve strane, deo pored izbora slika--}}
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-3">
                {{--Mesto za reklamu sa desne strane, deo pored izbora slika--}}
            </div>
        </div>
    </div>
@endsection
